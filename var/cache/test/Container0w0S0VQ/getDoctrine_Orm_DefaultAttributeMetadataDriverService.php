 ...
 */
class getDoctrine_Orm_DefaultAttributeMetadataDriverService extends Nramos_SearchIndexer_Tests_TestKernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['doctrine.orm.default_attribute_metadata_driver'] = new \Doctrine\ORM\Mapping\Driver\AttributeDriver([(\dirname(__DIR__, 4).'/tests/Entity')], true);
    }
}
