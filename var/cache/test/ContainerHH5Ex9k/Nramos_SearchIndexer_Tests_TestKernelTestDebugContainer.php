 ...
 */
class Nramos_SearchIndexer_Tests_TestKernelTestDebugContainer extends Container
{
    protected $targetDir;
    ...
    protected static function getControllerResolverService($container)
    {
        ...
        $instance->allowControllers(['Nramos\\SearchIndexer\\Tests\\TestKernel', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'debug.container.dump' => ($container->targetDir.''.'/Nramos_SearchIndexer_Tests_TestKernelTestDebugContainer.xml'),
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'SearchBundle' => 'Nramos\\SearchIndexer\\SearchBundle',
            ...
            'kernel.container_class' => 'Nramos_SearchIndexer_Tests_TestKernelTestDebugContainer',
